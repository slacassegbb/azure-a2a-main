...
Write-Host ""
Write-Host "🌐 Bing Search API (Web Search) Configuration" -ForegroundColor Cyan
$bingSearchKey = Read-Host "Bing Search API Key (optional, press Enter to skip)"
...
if ($backendExists) {
    az containerapp update `
        ...
        --set-env-vars `
            ...
            "BING_SEARCH_API_KEY=$bingSearchKey" `
            "A2A_HOST=FOUNDRY" `
