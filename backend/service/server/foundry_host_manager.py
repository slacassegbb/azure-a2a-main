...
class FoundryHostManager(ApplicationManager):
    ...
    async def process_message(self, message: Message, agent_mode: bool = None, enable_inter_agent_memory: bool = False, workflow: str = None, workflow_goal: str = None, available_workflows: list = None, user_id: str = None, user_timezone: str = "UTC"):
