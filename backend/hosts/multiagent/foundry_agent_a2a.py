...
{{"is_successful": true/false, "reason": "brief reason"}}"""
    ...
    async def run_conversation_with_parts(self, message_parts: List[Part], context_id: Optional[str] = None, event_logger=None, agent_mode: bool = False, enable_inter_agent_memory: bool = False, workflow: Optional[str] = None, workflow_goal: Optional[str] = None, available_workflows: Optional[List[Dict[str, Any]]] = None, user_id: Optional[str] = None, user_timezone: str = "UTC") -> Any:
        """
