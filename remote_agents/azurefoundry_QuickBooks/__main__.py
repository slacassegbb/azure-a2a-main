...
def create_a2a_server(host: str = DEFAULT_HOST, port: int = DEFAULT_PORT):
    ...
    skills = [
        AgentSkill(
            id='quickbooks_customers',
            name='QuickBooks Customer Management',
            description="Search, create, update, and manage customer records in QuickBooks Online. Access customer details, contact information, and transaction history.",
            tags=['quickbooks', 'customers', 'crm', 'contacts'],
            examples=[
                'Show me all customers with Tech in their name',
                'Create a new customer for XYZ Corporation',
        ...
        AgentSkill(
            id='quickbooks_invoices',
            name='QuickBooks Invoice Management',
            description="Create, search, and manage invoices in QuickBooks Online. Track payments, view invoice details, and manage accounts receivable.",
            tags=['quickbooks', 'invoices', 'billing', 'accounts receivable'],
            examples=[
        ...
        AgentSkill(
            id='quickbooks_bills_expenses',
            name='QuickBooks Bills & Expenses',
            description="Manage bills, purchases, and expenses in QuickBooks Online. Track vendor payments, record expenses, and manage accounts payable.",
            tags=['quickbooks', 'bills', 'expenses', 'accounts payable', 'vendors'],
            examples=[
        ...
        AgentSkill(
            id='quickbooks_reports',
            name='QuickBooks Financial Reports',
            description="Generate financial reports including Profit & Loss, Balance Sheet, and custom queries. Access company information and financial summaries.",
            tags=['quickbooks', 'reports', 'financial', 'accounting', 'P&L', 'balance sheet'],
            examples=[
                'Show me the Profit and Loss report',
                'Get the Balance Sheet',
                'What is our company information?',
                'Query all accounts receivable over $1000',
                'Generate a sales report'
            ],
        ),
        AgentSkill(
            id='quickbooks_vendors',
            name='QuickBooks Vendor Management',
            description="Manage vendor/supplier records in QuickBooks Online. Create, update, and track vendor information and payment history.",
            tags=['quickbooks', 'vendors', 'suppliers', 'procurement'],
            examples=[
        ...
        AgentSkill(
            ...
            examples=[
                ...
                'Search for QuickBooks best practices',
...
async def launch_ui(host: str = "0.0.0.0", ui_port: int = DEFAULT_UI_PORT, a2a_port: int = DEFAULT_PORT):
    ...
    print("Starting QuickBooks Agent UI and A2A server...")
    ...
    skills = [
        AgentSkill(
            id='quickbooks_customers',
            name='QuickBooks Customer Management',
            description="Search, create, update, and manage customer records in QuickBooks Online.",
            tags=['quickbooks', 'customers', 'crm', 'contacts'],
            examples=[
                'Show me all customers with Tech in their name',
                'Create a new customer for XYZ Corporation',
        ...
        AgentSkill(
            id='quickbooks_invoices',
            name='QuickBooks Invoice Management',
            description="Create, search, and manage invoices in QuickBooks Online. Track payments and accounts receivable.",
            tags=['quickbooks', 'invoices', 'billing', 'accounts receivable'],
            examples=[
                'Show me all unpaid invoices',
        ...
        AgentSkill(
            id='quickbooks_bills',
            name='QuickBooks Bills & Expenses',
            description="Manage bills, purchases, and expenses. Track vendor payments and accounts payable.",
            tags=['quickbooks', 'bills', 'expenses', 'vendors'],
            examples=[
                'Show me all bills due this week',
                'Create a bill from vendor Office Supplies Inc',
                'List all purchases this month'
        ...
        AgentSkill(
            id='quickbooks_reports',
            name='QuickBooks Financial Reports',
            description="Generate financial reports including Profit & Loss, Balance Sheet, and custom queries.",
            tags=['quickbooks', 'reports', 'financial', 'accounting'],
            examples=[
                'Show me the Profit and Loss report',
                'Get the Balance Sheet',
                'What is our company information?'
    ...
    with gr.Blocks(theme=gr.themes.Ocean(), title="QuickBooks Agent Chat") as demo:
    ...
    print(f"Launching QuickBooks Agent Gradio interface on {host}:{ui_port}...")
    demo.queue().launch(server_name=host, server_port=ui_port)
    print("QuickBooks Agent Gradio application has been shut down.")
...
async def main_async(host: str = DEFAULT_HOST, port: int = DEFAULT_PORT):
    ...
    skills = [
        ...
        AgentSkill(
            ...
            name='QuickBooks Financial Reports',
            description="Generate financial reports including Profit & Loss, Balance Sheet, and custom queries. Access company information and financial summaries.",
            tags=['quickbooks', 'reports', 'financial', 'accounting', 'P&L'],
            examples=[
                'Show me the Profit and Loss report',
                'Get the Balance Sheet',
                'What is our company information?',
