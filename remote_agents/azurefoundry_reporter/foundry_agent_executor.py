    ...
    async def execute(
        ...
        async with FoundryReporterAgentExecutor._request_semaphore:
            ...
            if FoundryReporterAgentExecutor._api_call_count >= FoundryReporterAgentExecutor._max_api_calls_per_minute:
                logger.warning(f"⚠️ API call count ({FoundryReporterAgentExecutor._api_call_count}) at limit, requests may be throttled by Azure")
            
            FoundryReporterAgentExecutor._api_call_count += 1
