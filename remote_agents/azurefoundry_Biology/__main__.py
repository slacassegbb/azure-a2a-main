...
def _build_agent_skills() -> List[AgentSkill]:
    ...
    return [
        ...
        AgentSkill(
            id='precalc',
            name='Pre-calculus Study Buddy',
            description="This agent knows the Pre-Calculus curriculum and can help students study for the exam by providing explanations, answering questions, and offering practice problems.",
            tags=['precalculus', 'math', 'study', 'practice problems'],
            examples=[
                'Example query 1 - Create a study guide for chapter 5 in Pre-Calculus.',                
            ],
        ),
...
def _create_agent_card(host: str, port: int) -> AgentCard:
    ...
    return AgentCard(
        name='Benjamin School Biology Teacher',  # ⚠️ CHANGE THIS to your agent's name
        description="This agent knows the Biology curriculum and can help students study for the exam by providing explanations, answering questions, and offering practice problems.",  # ⚠️ CHANGE THIS
