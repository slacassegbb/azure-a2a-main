...
"This essay reads like an A paper, here's what you can improve:" 
* Item 1, location of the content being reviewed. 
* Item 2, location of the content being reviewed.
"""
