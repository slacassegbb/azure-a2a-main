...
def _build_skills():
    ...
    return [
        AgentSkill(
            id='googlemaps_search_places',
            name='Google Maps Place Search',
            description="Search for places, businesses, addresses, landmarks, and points of interest using Google Maps.",
            tags=['googlemaps', 'places', 'search', 'location', 'restaurants', 'businesses'],
            examples=[
                'Find Italian restaurants near Times Square, New York',
                'Where is the nearest pharmacy in downtown Toronto?',
                'Search for coffee shops in Montreal',
            ],
        ),
        AgentSkill(
        ...
        AgentSkill(
            ...
            tags=['googlemaps', 'routes', 'directions', 'navigation', 'driving', 'walking'],
            examples=[
                'How long is the drive from Montreal to Quebec City?',
                'Give me walking directions from Central Park to Times Square',
