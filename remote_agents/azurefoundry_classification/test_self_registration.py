...
def create_test_agent_card(host: str = DEFAULT_HOST, port: int = DEFAULT_PORT) -> AgentCard:
    ...
    return AgentCard(
        name='AI Foundry Expert Agent',
        description="An intelligent agent powered by Azure AI Foundry with human expert consultation capabilities.",
...
async def test_self_registration():
    ...
    print("🧪 Testing Azure Foundry Expert Agent Self-Registration")
    print("=" * 60)
