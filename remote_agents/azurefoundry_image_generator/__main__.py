...
from foundry_agent_executor import (
    ...
    initialize_foundry_image_generators_at_startup)
...
async def launch_ui(
    ...
    def check_system_status():
        ...
        return (
            "✅ **Status:** Image Generator Ready – Share your prompt for a new visual!"
        )
    ...
    with gr.Blocks(
        theme=gr.themes.Ocean(), title="AI Foundry Image Generator Agent"
    ) as demo:
        gr.Image(
            "static/a2a.png",
            width=100,
    ...
    print(
        f"Launching AI Foundry Image Generator Agent Gradio interface on {host}:{ui_port}..."
    )
    demo.queue().launch(
        server_name=host,
        server_port=ui_port,
