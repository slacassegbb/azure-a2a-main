...
DEFAULT_PORT = 9004  # Fraud agent A2A port
DEFAULT_UI_PORT = 9104  # Fraud agent UI port

# UI Configuration - Updated for Fraud agent
APP_NAME = "foundry_fraud_app"
...
def create_a2a_server(host: str = DEFAULT_HOST, port: int = DEFAULT_PORT):
    ...
    async def health_check(request: Request) -> PlainTextResponse:
        return PlainTextResponse('AI Foundry Fraud Intelligence Agent is running!')
