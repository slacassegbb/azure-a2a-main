...
def _build_skills():
    ...
    return [
        AgentSkill(
            ...
            description="Create professional PowerPoint presentations from text descriptions. Supports slides with text, bullet points, tables, charts, shapes, and professional design themes.",
...
def _build_agent_card(host: str, port: int):
    ...
    return AgentCard(
        ...
        description="An Azure AI Foundry agent that creates professional PowerPoint presentations and returns downloadable .pptx files.",
