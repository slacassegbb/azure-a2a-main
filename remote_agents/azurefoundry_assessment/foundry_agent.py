...
"""
    ...
    async def cleanup_shared_resources(cls):
        """Clean up shared assessment document search resources (call when shutting down completely)."""
        try:
            if cls._shared_vector_store or cls._shared_uploaded_files:
                ...
                logger.info("Shared assessment document search resources cleaned up")
                
        except Exception as e:
            logger.error(f"Error cleaning up shared assessment document search resources: {e}")
