    ...
    async def execute(
        ...
        async with FoundryAssessmentAgentExecutor._request_semaphore:
            ...
            if FoundryAssessmentAgentExecutor._api_call_count >= FoundryAssessmentAgentExecutor._max_api_calls_per_minute:
                logger.warning(f"⚠️ API call count ({FoundryAssessmentAgentExecutor._api_call_count}) at limit, requests may be throttled by Azure")
            
            FoundryAssessmentAgentExecutor._api_call_count += 1
