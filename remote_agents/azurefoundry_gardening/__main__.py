...
def _build_skills():
    ...
    return [
        ...
        AgentSkill(
            id='fan_control',
            name='Fan Control',
            description="Control the grow room fan (on/off) for air circulation, ventilation, humidity control, and temperature regulation. Optionally run for a specified duration then auto-off.",
            tags=['gardening', 'ventilation', 'fan', 'iot', 'smart-home', 'air-circulation'],
            examples=[
                "Turn on the fan",
                "Run the fan for 30 minutes",
                "Turn off the fan",
                "The plants look humid, turn on ventilation",
            ],
        ),
        AgentSkill(
