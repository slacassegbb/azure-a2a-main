...
DEFAULT_PORT = 8002  # Changed from 10007 to avoid conflict
DEFAULT_UI_PORT = 8087  # Changed from 8085 to avoid conflict

# UI Configuration - Updated for Deep Search agent
APP_NAME = "foundry_deep_search_app"  # Changed from foundry_expert_app
...
def create_a2a_server(host: str = DEFAULT_HOST, port: int = DEFAULT_PORT):
    ...
    async def health_check(request: Request) -> PlainTextResponse:
        return PlainTextResponse('AI Foundry Deep Search Knowledge Agent is running!')
