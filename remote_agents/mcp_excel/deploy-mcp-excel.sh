...
# Deploy Excel MCP Server to Azure Container Apps
# Usage: ./deploy-mcp-excel.sh
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -p|--port)
            ...
            ;;
        -h|--help)
            echo "Usage: ./deploy-mcp-excel.sh [options]"
            echo ""
            echo "Options:"
...
echo -e "${CYAN}Deploying Excel MCP Server to Azure Container Apps${NC}"
echo -e "${CYAN}====================================================${NC}"
...
# Summary
echo -e "${CYAN}========================================${NC}"
echo -e "${GREEN}Excel MCP Server Deployed!${NC}"
echo -e "${CYAN}========================================${NC}"
echo ""
