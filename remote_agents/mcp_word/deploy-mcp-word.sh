...
# Deploy Word MCP Server to Azure Container Apps
# Usage: ./deploy-mcp-word.sh
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -p|--port)
            ...
            ;;
        -h|--help)
            echo "Usage: ./deploy-mcp-word.sh [options]"
            echo ""
            echo "Options:"
...
echo -e "${CYAN}Deploying Word MCP Server to Azure Container Apps${NC}"
echo -e "${CYAN}==================================================${NC}"
...
# Summary
echo -e "${CYAN}========================================${NC}"
echo -e "${GREEN}Word MCP Server Deployed!${NC}"
echo -e "${CYAN}========================================${NC}"
echo ""
...
echo -e "${CYAN}  Health: https://$CONTAINER_FQDN/health${NC}"
