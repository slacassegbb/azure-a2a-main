...
def _build_agent_skills() -> List[AgentSkill]:
    ...
    return [
        ...
        AgentSkill(
            id='apes',
            name='AP Environmental Science Study Guide',
            description="This agent knows the AP Environmental Science curriculum and can help students study for the exam by providing explanations, answering questions, and offering practice problems.",
            tags=['environmental science', 'APES', 'study guide'],
            examples=[
                'Create a study guide for chapter 5 in AP Environmental Science'                
            ],
        ),
...
def _create_agent_card(host: str, port: int) -> AgentCard:
    ...
    return AgentCard(
        name='Benjamin School AP Environmental Science Study Buddy',  # ⚠️ CHANGE THIS to your agent's name
        description="This agent knows the AP Environmental Science curriculum and can help students study for the exam by providing explanations, answering questions, and offering practice problems.",  # ⚠️ CHANGE THIS
