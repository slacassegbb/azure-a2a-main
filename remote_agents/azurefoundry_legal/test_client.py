...
async def main() -> None:
    """
    Test client for AI Foundry Legal Agent A2A demo.
    ...
    # Use environment variable or default to our AI Foundry legal agent port
    base_url = os.getenv('A2A_BASE_URL', 'http://localhost:8006')
    logger.info(f"🔗 Connecting to AI Foundry Legal Agent at: {base_url}")
