...
- **(A2A) Azure AI Foundry Agent — Image Generation Agent** *(Experimental)* (Directory: `remote_agents\azurefoundry_image_generator`) (**A2A_PORT=9010**)
...
- **(A2A) Azure AI Foundry Agent — Customer Support Agent (MCP)** *(Experimental)* (Directory: `remote_agents\azurefoundry_SN`) (**A2A_PORT=8000**)
